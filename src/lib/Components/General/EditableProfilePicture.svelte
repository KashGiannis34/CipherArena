...
>
  ...
  {#if isOwnProfile}
    <label class="camera-icon">
      ...
      >
        <path
          d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zm3.92.92l10.06-10.06 0.92 0.92L7.84 19.09H6.92v-0.92zM20.71 7.04a1.003 1.003 0 0 0 0-1.42l-2.34-2.34a1.003 1.003 0 0 0-1.42 0l-1.83 1.83 3.75 3.75 1.84-1.82z"
        />
      </svg>
    </label>
  {/if}
