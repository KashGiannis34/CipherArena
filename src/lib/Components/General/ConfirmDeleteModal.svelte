...
{#if visible}
  ...
  >
    ...
    >
      ...
      <p class="desc">
        This action is permanent and cannot be undone. To confirm, type your username <strong
          >@{username}</strong
        >.
      </p>
...
<style>
  ...
  .secondary:focus-visible {
    outline: none;
    box-shadow: 0 0 0 2px rgba(180, 172, 255, 0.6);
  }
  ...
  .danger:focus-visible {
    outline: none;
    box-shadow: 0 0 0 2px rgba(255, 109, 109, 0.6);
  }
