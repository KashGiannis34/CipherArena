...
<div class="page">
  <Container
    style="--minWidth: clamp(320px, 90vw, 960px); --maxWidth: min(960px, 90vw); --flexDir: column; padding-top: 30px; padding-left: 40px; padding-right: 40px;"
  >
              ...
              {:else}
                ...
                <div class="result-details">
                  ...
                  {#if result.correctAnswerMod26 !== undefined}
                    <p>
                      <strong>Correct answer (mod 26):</strong>
                      {result.correctAnswerMod26}
                    </p>
                  {/if}
                  {#if result.correctAnswerLetter !== undefined}
                    <p>
                      <strong>Correct answer (letter):</strong>
                      {result.correctAnswerLetter}
                    </p>
                  {/if}
                </div>
              {/if}
